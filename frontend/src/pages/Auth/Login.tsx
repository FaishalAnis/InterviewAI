      ...
      <div className="flex-grow flex items-center justify-center py-10">
        <div className="w-full max-w-md glass-panel p-8 rounded-3xl border border-white/5 shadow-2xl relative">
          <div className="text-center mb-6">
            ...
            <p className="text-xs text-slate-400 mt-1">Practice mock interviews to land your dream role.</p>
          </div>

          {isExpired && (
            <div className="mb-4 p-3 bg-indigo-950/20 border border-indigo-500/20 text-indigo-300 text-xs rounded-xl flex items-center space-x-2">
              <AlertCircle size={14} />
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <label className="flex items-center space-x-2 text-slate-300 cursor-pointer">
                <input
                  type="checkbox"
                  {...register("rememberMe")}
                  className="rounded border-white/10 text-primary-600 bg-slate-950/40"
                />
